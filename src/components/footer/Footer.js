    ...
    <div className="footer">
      <div className="fLists">
        ...
        <ul className="fList">
          ...
          <li className="fListItem">MyBooking.com for Travel Agents</li>
        </ul>
        <ul className="fList">
          <li className="fListItem">Coronavirus (COVID-19) FAQs</li>
          <li className="fListItem">About MyBooking.com</li>
          ...
          <li className="fListItem">Home We Work</li>
      ...
      <div className="fText">
        Copyright © 1996–2022 MyBooking.com™. All rights reserved.
      </div>
    </div>
  );
};
